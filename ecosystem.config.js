module.exports = {
  ...
  deploy: {
    production: {
      ...
      "post-deploy":
        "cd backend && npm ci && npm run build && pm2 reload ../ecosystem.config.js --env production && cd ../frontend && npm ci && NODE_OPTIONS=--openssl-legacy-provider npm run build && rsync -avz build/ /var/www/mesto",
    },
  },
};
